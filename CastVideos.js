 ...
 **/
var MEDIA_SOURCE_URL = 'video/sample.json';
...
CastPlayer.prototype.initializeCastPlayer = function() {
  ...
  var applicationID = '4F8B3483'; //default: 4F8B3483 , mine: 6B83351A
...
CastPlayer.prototype.sessionListener = function(e) {
  appendMessage("init sessionListener");
  this.session = e;
  if( this.session ) {
...
CastPlayer.prototype.onRequestSessionSuccess = function(e) {
  console.log(appendMessage("launch error"));
  appendMessage(appendMessage("launch error"));
  this.session = e;
  this.deviceState = DEVICE_STATE.ACTIVE;
  this.updateMediaControlUI();
  this.loadMedia(this.currentMediaIndex);
